 ...
 */
typedef void(*robot_path_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const robot_path_t *msg, void *userdata);
 ...
 */
robot_path_t_subscription_t* robot_path_t_subscribe(lcm_t *lcm, const char *channel, robot_path_t_handler_t handler, void *userdata);
...
int64_t __robot_path_t_hash_recursive(const __lcm_hash_ptr *p);
