...
#ifndef _occupancy_grid_t_h
#define _occupancy_grid_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _occupancy_grid_t occupancy_grid_t;
struct _occupancy_grid_t
{
    int64_t    utime;
    float      origin_x;
    float      origin_y;
...
/**
 * Create a deep copy of a occupancy_grid_t.
 * When no longer needed, destroy it with occupancy_grid_t_destroy()
 */
occupancy_grid_t* occupancy_grid_t_copy(const occupancy_grid_t* to_copy);

/**
 * Destroy an instance of occupancy_grid_t created by occupancy_grid_t_copy()
 */
void occupancy_grid_t_destroy(occupancy_grid_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _occupancy_grid_t_subscription_t occupancy_grid_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * occupancy_grid_t is received.
 */
typedef void(*occupancy_grid_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const occupancy_grid_t *msg, void *userdata);

/**
 * Publish a message of type occupancy_grid_t using LCM.
 *
 ...
 */
int occupancy_grid_t_publish(lcm_t *lcm, const char *channel, const occupancy_grid_t *msg);

/**
 * Subscribe to messages of type occupancy_grid_t using LCM.
 *
 ...
 */
occupancy_grid_t_subscription_t* occupancy_grid_t_subscribe(lcm_t *lcm, const char *channel, occupancy_grid_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by occupancy_grid_t_subscribe()
 */
...
/**
 * Encode a message of type occupancy_grid_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to occupancy_grid_t_encoded_size().
...
/**
 * Decode a message of type occupancy_grid_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with occupancy_grid_t_decode_cleanup().
 *
 ...
 */
int occupancy_grid_t_decode(const void *buf, int offset, int maxlen, occupancy_grid_t *msg);

/**
 * Release resources allocated by occupancy_grid_t_decode()
 * @return 0
 */
int occupancy_grid_t_decode_cleanup(occupancy_grid_t *p);

/**
 * Check how many bytes are required to encode a message of type occupancy_grid_t
 */
