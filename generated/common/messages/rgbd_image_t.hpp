...
int rgbd_image_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = this->rgb_image._encodeNoHash(buf, offset + pos, maxlen - pos);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = this->depth_image._encodeNoHash(buf, offset + pos, maxlen - pos);
    if(tlen < 0) return tlen; else pos += tlen;
...
int rgbd_image_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = this->rgb_image._decodeNoHash(buf, offset + pos, maxlen - pos);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = this->depth_image._decodeNoHash(buf, offset + pos, maxlen - pos);
    if(tlen < 0) return tlen; else pos += tlen;
