...
int ball_detections_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ball_detections_t::getEncodedSize() const
{
...
int ball_detections_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;

    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->num_detections, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int ball_detections_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;

    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->num_detections, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int ball_detections_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
