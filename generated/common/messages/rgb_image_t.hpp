...
int rgb_image_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int rgb_image_t::getEncodedSize() const
{
...
int rgb_image_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    if(this->size > 0) {
        tlen = __int8_t_encode_array(buf, offset + pos, maxlen - pos, &this->raw_image[0], this->size);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int rgb_image_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    if(this->size) {
        ...
        tlen = __int8_t_decode_array(buf, offset + pos, maxlen - pos, &this->raw_image[0], this->size);
        if(tlen < 0) return tlen; else pos += tlen;
    }
...
int rgb_image_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
