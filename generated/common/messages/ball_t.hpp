...
int ball_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ball_t::getEncodedSize() const
{
...
int ball_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->velocity[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int ball_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->velocity[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    return pos;
}

int ball_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
